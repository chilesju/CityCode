...
namespace User_Administration
{
	...
	public class CatagoryForm : System.Windows.Forms.Form
	{
		...
		public CatagoryForm(ProfileInfo userProfile)
		{
			...
			try
			{
                ...
                this.GetUsersCatagories(this.userProfile.UserName);
		...
		{
            DataSet set1 = AdminManager.LoadCatagories();
		...
		{
			DataSet set1 = this.userProfile.GetUsersCatagory();
