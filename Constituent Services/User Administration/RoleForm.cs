...
namespace User_Administration
{
	...
	public class RoleForm : System.Windows.Forms.Form
	{
		...
		public RoleForm(string role, int roleID)
		{
            this.components = null;
            this.InitializeComponent();
		...
		private void btnSave_Click(object sender, System.EventArgs e)
		{
            try
            {
                if (this.editMode == false && RoleManager.RoleNameValid(this.tbxRole.Text) == false)
                {
                ...
                else
                {
                    ...
                    {
                        RoleManager.ModifyRoleName(this._roleID, this.tbxRole.Text.Trim());
                    }
                    else
                    {
                        RoleManager.CreateRole(this.tbxRole.Text.Trim());
                    }
            ...
            {
                MessageBox.Show(this, "Error Saving the Role Information: " + ex.ToString(), "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
