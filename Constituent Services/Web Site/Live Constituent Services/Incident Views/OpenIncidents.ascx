...
<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%">
	...
	<TR>
		<TD>
			<P><asp:datagrid id="DataGrid1" ShowFooter="True" CssClass="regtext" Width="100%" PageSize="50" AutoGenerateColumns="False"
					runat="server" AllowPaging="True" OnPageIndexChanged="DataGrid1_PageIndexChanged">
