			...
			<asp:datagrid id="DataGrid1" CssClass="regtext" Width="100%" PageSize="25" AutoGenerateColumns="False"
				...
				<Columns>
					<asp:TemplateColumn HeaderText="Incident Number">
						<ItemTemplate>
							<asp:LinkButton id=lblIncidentNumber runat="server" CommandName="Edit" CommandArgument="IncidentNumber" Text='<%#(DataBinder.Eval(Container, "DataItem.Incident Number")) %>' CssClass="reglinks"></asp:LinkButton>
						</ItemTemplate>
					</asp:TemplateColumn>
