...
<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
	<TR>
		<TD class="regtext">
			Returns the last 60 closed Incidents. To View more use the Search option.
		</TD>
	</TR>
	<TR>
		<TD>
			<asp:datagrid id="DataGrid1" CssClass="regtext" Width="100%" PageSize="25" AutoGenerateColumns="False"
				...
				<Columns>
					<asp:TemplateColumn HeaderText="Incident Number">
						<ItemTemplate>
							<asp:LinkButton id=lblIncidentNumber runat="server" Text='<%#(DataBinder.Eval(Container, "DataItem.Incident Number")) %>' CommandArgument="IncidentNumber" CommandName="Edit" CssClass="reglinks"></asp:LinkButton>
						</ItemTemplate>
					</asp:TemplateColumn>
