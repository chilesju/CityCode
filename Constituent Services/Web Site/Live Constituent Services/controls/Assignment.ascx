...
<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
	...
	<TR>
		<TD><asp:button id="btnReassign" runat="server" Text="Reassign Call" OnClick="btnReassign_Click1"></asp:button></TD>
	</TR>
	<TR>
	...
	<TR>
		<TD>
			<asp:button id="btnAddCase" runat="server" CssClass="regtext" Text="Add Case to Incident" Visible="False" OnClick="btnAddCase_Click1"></asp:button>&nbsp;
			<asp:button id="btnRemove" runat="server" CssClass="regtext" Text="Remove Case From Incident"
				Visible="False" Enabled="False" OnClick="btnRemove_Click1"></asp:button></TD>
	</TR>
	<TR>
		<TD>
	...
	<TR>
		<TD><asp:button id="btnNewComment" runat="server" Text="Add a new comment to resolution" OnClick="btnNewComment_Click1"></asp:button><SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; mso-fareast-font-family: 'Times New Roman'; mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA"></SPAN></TD>
	</TR>
	<TR>
