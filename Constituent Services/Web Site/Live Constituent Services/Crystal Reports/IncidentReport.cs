...
namespace ConstituentServices.Crystal_Reports {
    ...
    public class IncidentReport : ReportClass {
    ...
    public class CachedIncidentReport : Component, ICachedReport {
        
        public CachedIncidentReport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            IncidentReport rpt = new IncidentReport();
            rpt.Site = this.Site;
            return rpt;
        }
