...
<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
	...
	<TR>
		<TD><asp:button id="btnSearch" runat="server" Text="Search" tabIndex="10" OnClick="btnSearch_Click1"></asp:button>&nbsp;</TD>
	</TR>
	<TR>
		<TD align="center">
	...
	<TR>
		<TD colSpan="2"><asp:datagrid id="DataGrid1" runat="server" CssClass="regtext" Width="100%" ShowFooter="True"
				AllowSorting="True" AutoGenerateColumns="False" tabIndex="12" AllowPaging="True" OnPageIndexChanged="DataGrid1_PageIndexChanged" PageSize="50">
