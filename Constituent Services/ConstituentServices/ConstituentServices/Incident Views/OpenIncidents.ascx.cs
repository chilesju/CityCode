namespace Constituent_Services.Incident_Views
{
	...
	public class OpenIncidents : System.Web.UI.UserControl
	{
		...
		public System.Drawing.Color PickColor(object incidentnumber)
		{
            ...
            //if(Incident.IsThisIncidentOverdue(Convert.ToInt32(incidentnumber)))
            //{
		...
		public void Bind()
		{
			...
			//{
				DataGrid1.DataSource= Incident.SelectAdminIncidents("O");
				DataGrid1.DataBind();
            ...
            //    DataGrid1.DataSource= Incident.SelectDepartmentIncidents(departmentId, "O");
            //    DataGrid1.DataBind();
            //}
            //else if(_userRights==Global.RoleDivision)
            //{
            //    int divisionId = Convert.ToInt32(Session["Division"]);
            //    DataGrid1.DataSource= Incident.SelectDivisionIncidents(divisionId, "O");
            //    DataGrid1.DataBind();
            //}
