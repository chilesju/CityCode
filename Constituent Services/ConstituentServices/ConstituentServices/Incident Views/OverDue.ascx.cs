namespace Constituent_Services.Incident_Views
{
	...
	public class OverDue : System.Web.UI.UserControl
	{
		...
		public void Bind()
		{
			...
			//{
				DataGrid1.DataSource= Incident.SelectAdminOVerDueIncidents();
				DataGrid1.DataBind();
            ...
            //    DataGrid1.DataSource= Incident.SelectDepartmentOVerDueIncidents(departmentId);
            //    DataGrid1.DataBind();
            //}
            //else if(_userRights==Global.RoleDivision)
            //{
            //    int divisionId = Convert.ToInt32(Session["Division"]);
            //    DataGrid1.DataSource= Incident.SelectDivisionOVerDueIncidents(divisionId);
            //    DataGrid1.DataBind();
            //}
