...
namespace Constituent_Services.controls
{
	public class Report
	{
		...
		public Report()
		{
			...
			//reportServer= ConfigurationSettings.AppSettings[Constituent_Services.Global.CfgKeyCrystalReportServer];
			//reportUserId= ConfigurationSettings.AppSettings[Constituent_Services.Global.CfgKeyCrystalReportUserId];
			//reportPassword= ConfigurationSettings.AppSettings[Constituent_Services.Global.CfgKeyCrystalReportPassword];
			//reportLocation= ConfigurationSettings.AppSettings[Constituent_Services.Global.CfgKeyCrystalLocation];
		}
