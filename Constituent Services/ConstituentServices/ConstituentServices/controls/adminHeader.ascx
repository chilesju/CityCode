<%@ Control Language="c#" AutoEventWireup="false" Codebehind="adminHeader.ascx.cs" Inherits="Constituent_Services.controls.header4" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
clearInterval(highlighting)
	...
	LIST-STYLE-IMAGE: url(http://www.topeka.org/images/arrow.gif)
}
BODY {
	MARGIN: 0px
}
	...
	<table id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="780" align="center"
		border="0">
		<TBODY>
			<tr>
												...
												<tr>
													<td bgColor="#f4f4f4">
														<table id="Table4" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
																...
																<td vAlign="top" bgColor="#f4f4f4">
																	<div align="center">
																		<table id="Table5" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
																			<tr>
																				<td background="http://www.topeka.org/images/nav_dotted.gif"><IMG height="3" src="http://www.topeka.org/images/spacer.gif" width="1"></td>
																			</tr>
																		</table>
																	</div>
																</td>
															...
															<tr>
																<td vAlign="top" bgColor="#f4f4f4">
																	<table id="Table6" style="WIDTH: 753px" cellSpacing="0" cellPadding="0" width="753" align="center"
																		border="0">
																		<tr class="smallText">
																			<td style="HEIGHT: 34px">
																				<div align="center"><IMG height="15" src="http://www.topeka.org/images/upper_left.gif" width="15"></div>
																			</td>
																			<td class="regtext" align="center" width="100%" bgColor="#ffffff"><asp:datalist id="linksTabs" runat="server" RepeatDirection="Horizontal" CssClass="reglinks">
																					<ItemTemplate>
																						<a href='<%# ((Utilites.LinkTabs) Container.DataItem).Path %> ' class="reglinks">
																							<%#((Utilites.LinkTabs)Container.DataItem).Name%>
																						</a>|
																					</ItemTemplate>
																				</asp:datalist><asp:linkbutton id="lkbtnLogOff" runat="server" CssClass="reglinks" ForeColor="Red">Click Here to Log Off</asp:linkbutton></td>
																		<tr>
