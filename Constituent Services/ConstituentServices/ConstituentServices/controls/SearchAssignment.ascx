...
<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
	...
	<TR>
		<TD style="HEIGHT: 21px"><asp:label id="Label3" runat="server" CssClass="regtext">Department:</asp:label>&nbsp;<asp:dropdownlist id="departmentList" runat="server" CssClass="regtext" tabIndex="2" AutoPostBack="True"></asp:dropdownlist></TD>
	</TR>
	<TR>
	...
	<TR>
		<TD style="HEIGHT: 8px"><asp:button id="btnSearch" runat="server" CssClass="regtext" Text="Search" tabIndex="10"></asp:button>&nbsp;
	...
	<TR>
		<TD colSpan="2">
			<asp:datagrid id="Datagrid2" CssClass="regtext" runat="server" Width="100%" AutoGenerateColumns="False"
				AllowSorting="True" ShowFooter="True" tabIndex="12">
